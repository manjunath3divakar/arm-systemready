...
flowchart LR
    ...
    click D "https://github.com/manjunath3divakar/arm-systemready/blob/flow_docs/docs/systemredy_devicetree_band_flow.md#network-boot.md#3-linux-automation-flow" "Go to Linux Automation Flow"
